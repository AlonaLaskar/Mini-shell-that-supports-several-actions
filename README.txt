A mini-shell that supports a pipes ,signals and ^z ,fg"". 
==Description==
Functions:
...
At the end of the program when the user clicks "DONE" a statistic of usage of the pipes and a number of commands will come out and the program will come out.
...
New-void sig_handler(int sigNum)- When we use the signal the method will perform a non-blocking wait and release the resources.
==How to compile?==
